...
from espnet2.main_funcs.plot_attentions import plot_attentions
...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument("--seed", type=int, default=777, help="Random seed")
        group.add_argument(
            "--num_workers",
            type=int,
            default=1,
        ...
        group = parser.add_argument_group("plot attentions related")
        group.add_argument(
            "--plot_attentions",
            type=str2bool,
            default=False,
            help='Perform on "plot attentions" mode',
        )
        ...
        group.add_argument("--freeze-mods", type=str, default=[], nargs="*")
        group.add_argument(
            "--init_param",
            type=str,
            default=[],
    ...
    def main_worker(cls, args: argparse.Namespace):
        ...
        # 6.5 freeze components
        if args.freeze_mods:
            freeze_modules(model, args.freeze_mods)

        if args.dry_run:
            pass
        elif args.plot_attentions:
            ...
            plot_attentions(
                model=model,
                iterator=cls.build_streaming_iterator(
