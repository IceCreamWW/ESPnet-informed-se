...
class TemporalConvNet(nn.Module):
    def __init__(
        self, N, B, H, P, X, R, C, norm_type="gLN", causal=False, mask_nonlinear="relu", O=None
    ):
        ...
        # [M, B, K] -> [M, C*N, K]
        mask_conv1x1 = nn.Conv1d(B, C * N if O is None else C * O, 1, bias=False)
        # Put together
    ...
    def forward(self, mixture_w):
        ...
        score = score.view(M, self.C, N if self.O is None else self.O, K)  # [M, C*N, K] -> [M, C, N, K]
