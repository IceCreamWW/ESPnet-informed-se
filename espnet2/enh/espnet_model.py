    ...
    def si_snr_loss_zeromean_multi_grained(ref, inf):
        ...
        while True:
            ...
            for start in range(0, T, base):
                ...
                pair_wise_si_snr += ESPnetEnhancementModel.si_snr_loss_zeromean(ref[:,start:end], inf[:,start:end])
            base *= 4
        pair_wise_si_snr += ESPnetEnhancementModel.si_snr_loss_zeromean(ref, inf)
