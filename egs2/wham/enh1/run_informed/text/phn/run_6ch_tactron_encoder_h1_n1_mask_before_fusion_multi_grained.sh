...
test_sets="et05_simu_isolated_6ch_tracki"
...
./enh_ti.sh \
    ...
    --valid_set "${valid_set}" \
    --test_sets "${test_sets}" \
    --enh_tag "conv_tasnet_informed_text_phn_6ch_tactron_encoder_h1_n1_mask_before_fusion_multi_grained" \
    --channels 6 \
    ...
    --ref_channel 3 \
    --spk_num 1 \
    --enh_config ./conf/tuning/train_enh_conv_tasnet_phn_informed_tactron_encoder_6ch_h1_n1_mask_before_fusion_multi_grained.yaml \
